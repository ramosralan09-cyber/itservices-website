...
const categories = [
  {
    ...
    description:
      'CCTV IP, analógicas, PTZ - Hikvision, Uniview, Epcom desde 2MP hasta 4K',
  ...
  },
  {
    ...
    description:
      'Cables UTP, conectores, fuentes de poder, gabinetes - Varias marcas',
    ...
    try {
      ...
      if (!response.ok || !result.ok) {
        if (result.error === 'duplicate') {
          setError(
            'Este email ya está registrado en la lista de espera. ¡Gracias por tu interés!',
          );
        } else {
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto">
              Estamos preparando nuestra tienda en línea con los mejores productos
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {categories.map((category, index) => (
              ...
              >
                <div
                  className={`w-14 h-14 ${category.iconBg} rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}
                >
                  <category.icon
            ...
            {!submitted ? (
              ...
              >
                ...
                >
                  ...
                  <p className="text-white text-4xl font-bold tracking-wider mb-2">
                    {discountCode}
                  </p>
                ...
                <p className="text-blue-100 mb-6">
                  Te notificaremos cuando la tienda esté lista. Revisa tu email
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-6">
          ...
          >
            ...
            <p className="text-gray-400 mb-6 max-w-2xl mx-auto">
              Mientras preparamos nuestra tienda online, contáctanos directamente para
