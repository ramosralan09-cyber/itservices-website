...
import { Briefcase, MessageCircle, Star, Building2, TrendingUp, Award } from 'lucide-react';
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto mb-8">
              Más de <span className="text-skyBlue font-bold">120 proyectos completados</span> en toda la isla.
              Desde pequeños negocios hasta instalaciones gubernamentales.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mt-12">
              {[
                { icon: Building2, label: 'Proyectos', value: '120+', color: 'text-blue-400', bgColor: 'bg-blue-500/10' },
                { icon: TrendingUp, label: 'Años Experiencia', value: '12+', color: 'text-green-400', bgColor: 'bg-green-500/10' },
                { icon: Award, label: 'Satisfacción', value: '98%', color: 'text-orange-400', bgColor: 'bg-orange-500/10' },
              ].map((stat, index) => (
                <motion.div
                  key={stat.label}
                  initial={{ opacity: 0, y: 20 }}
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-6 text-center relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/20 backdrop-blur-sm rounded-full mb-6">
              ...
              <span className="text-white font-semibold text-sm">Únete a Nuestros Clientes</span>
            </div>
            ...
            <p className="text-white/90 text-lg md:text-xl mb-8">
              Más de 120 clientes satisfechos confían en nosotros en toda la isla
            </p>
