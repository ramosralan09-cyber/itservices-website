        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-3xl">
              Estamos listos para ayudarte con tu proyecto de cámaras de seguridad,
              redes empresariales y control de acceso en Puerto Rico.
              Respuesta garantizada en 24–48 horas para negocios en toda la isla.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            <div className="grid gap-10 md:grid-cols-2 items-start">
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm text-gray-300 mb-4 text-center">
                  ...
                  y atendemos proyectos de cámaras de seguridad, redes y control de acceso
