            ...
            >
              ...
              <div className="flex flex-wrap justify-center gap-6 text-sm">
                ...
                <div className="flex items-center gap-2 text-gray-300">
                  ...
                  <span>Optimización de Infraestructura</span>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          <div className="container mx-auto px-6 relative z-10">
            ...
            >
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Soluciones personalizadas para impulsar la seguridad y la transformación
              ...
              {[
                {
                  ...
                  description:
                    'Evaluación completa de tu infraestructura actual, identificación de vulnerabilidades y recomendaciones de mejora en redes, cámaras y acceso.',
                  features: [
                ...
                },
                {
                  ...
                  description:
                    'Diseño de planes tecnológicos alineados con tus objetivos de negocio a corto, mediano y largo plazo.',
                  features: [
                ...
                },
                {
                  ...
                  description:
                    'Dirección profesional de proyectos tecnológicos desde la planificación hasta la implementación exitosa.',
                  features: [
                    'Metodología ágil',
                ...
                },
                {
                  ...
                  description:
                    'Mejora de sistemas existentes, migración a cloud, virtualización y actualización de infraestructura legacy.',
                  features: [
                    'Migración cloud',
                    'Virtualización',
          ...
          <div className="container mx-auto px-6">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                ¿Necesitas ayuda para planificar tu próximo proyecto tecnológico?
              </h2>
              <p className="text-lg text-gray-300 mb-8">
                Te acompañamos en la evaluación, diseño y planificación de proyectos de
                seguridad, redes e infraestructura IT para tu negocio en Puerto Rico.
                Preparamos una propuesta clara, estratégica y fácil de implementar.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link
                  href="/portafolio"
                  className="inline-flex items-center justify-center px-8 py-3 rounded-xl border border-gray-600 text-gray-100 hover:border-violet-400 hover:text-violet-200 transition-all"
                >
