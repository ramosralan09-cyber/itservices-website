          ...
          <div className="container mx-auto px-6 relative z-10 py-20">
            ...
            >
              ...
              <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">
                Consultoría Tecnológica y Seguridad Empresarial en Puerto Rico
              </h1>
              <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed">
                Asesoría especializada para optimizar tu infraestructura de redes, seguridad y estrategia digital.
              </p>
              ...
              {[
                {
                  ...
                  description:
                    'Evaluación completa de tu infraestructura actual, identificación de vulnerabilidades y recomendaciones de mejora.',
                  features: [
