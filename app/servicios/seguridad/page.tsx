...
import { Shield, Camera, Eye, Lock, Smartphone, CheckCircle, Phone, MessageCircle, Zap, Sun, Wifi, Battery } from 'lucide-react';
...
export default function SeguridadPage() {
  ...
  const whatsappLink = "https://wa.me/19392842551?text=Hola%2C%20estoy%20interesado%20en%20una%20cotizaci%C3%B3n%20con%20IT%20Services%20%26%20Security.%20Servicio%3A%20Seguridad%20CCTV%20%7C%20Nombre%3A%20%5BEscribir%5D%20%7C%20Tel%C3%A9fono%3A%20%5Bxxx-xxx-xxxx%5D";
        ...
        <div className="container mx-auto px-6 relative z-10 py-20">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed">
              CCTV 4K, control de acceso y soluciones completas de videovigilancia empresarial
            </p>
            ...
            {[
              {
                ...
                description: 'Sistemas de cámaras de seguridad 4K/8MP con acceso remoto, grabación continua y detección inteligente. Marcas: Hikvision, Uniview, Dahua.',
                features: ['Cámaras 4K / 8MP', 'Acceso remoto 24/7', 'Grabación ilimitada', 'Detección de movimiento', 'Visión nocturna IR', 'App móvil incluida'],
                color: 'yellow',
              ...
              },
              {
                ...
                description: 'Gestión completa de accesos con tecnología RFID, biométrica o PIN. Control total desde tu celular con historial detallado.',
                features: ['Tarjetas RFID/Proximity', 'Biométrico (huella)', 'Códigos PIN', 'App móvil', 'Historial completo', 'Alertas en tiempo real'],
                color: 'blue',
              ...
              },
              {
                ...
                description: 'Cámaras con IA para reconocimiento facial, lectura de placas (LPR), conteo de personas y análisis de comportamiento.',
                features: ['Reconocimiento facial', 'Lectura de placas (LPR)', 'Conteo de personas', 'Análisis de patrones', 'Alertas inteligentes', 'Integración total'],
                color: 'violet',
              ...
              },
              {
                ...
                description: 'Acceso completo desde cualquier lugar con apps móviles para iOS y Android. Notificaciones push en tiempo real.',
                features: ['Apps iOS y Android', 'Notificaciones push', 'Reproducción remota', 'Control PTZ', 'Multi-sitio', 'Backup en nube'],
                color: 'green',
