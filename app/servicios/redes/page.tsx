...
import { Network, Wifi, Cable, Server, CheckCircle, ArrowRight, Phone, MessageCircle, Zap, Shield } from 'lucide-react';
...
export default function RedesPage() {
  ...
  const whatsappLink = "https://wa.me/19392842551?text=Hola%2C%20estoy%20interesado%20en%20una%20cotizaci%C3%B3n%20con%20IT%20Services%20%26%20Security.%20Servicio%3A%20Redes%20Empresariales%20%7C%20Nombre%3A%20%5BEscribir%5D%20%7C%20Tel%C3%A9fono%3A%20%5Bxxx-xxx-xxxx%5D";
        ...
        <div className="container mx-auto px-6 relative z-10 py-20">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">
              Servicios de Redes Empresariales
            </h1>
            <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed">
              Diseño e implementación de infraestructura de red completa para tu empresa
            </p>
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Desde cableado estructurado hasta soluciones WiFi empresariales
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description: 'Instalación profesional de cables Cat6/Cat6a certificados según normas TIA/EIA. Incluye racks, patch panels y documentación completa.',
                features: ['Certificación TIA/EIA', 'Documentación completa', 'Patch cords incluidos', 'Garantía 25 años'],
                color: 'blue',
                emoji: '🔌',
              ...
              },
              {
                ...
                description: 'Diseño e implementación de redes inalámbricas con cobertura completa. Access Points profesionales (Ubiquiti, Ruckus, TP-Link).',
                features: ['Site survey incluido', 'Múltiples SSIDs', 'Roaming automático', 'Gestión centralizada'],
                color: 'violet',
                emoji: '📡',
              ...
              },
              {
                ...
                description: 'Configuración de equipos de red empresariales: switches managed/unmanaged, routers, firewalls y balanceadores de carga.',
                features: ['VLANs configuradas', 'QoS optimizado', 'Redundancia', 'Monitoreo 24/7'],
                color: 'green',
                emoji: '🖥️',
              ...
              },
              {
                icon: Shield,
                title: 'Fibra Óptica',
                description: 'Instalación de enlaces de fibra óptica para backbone de red. Fusiones certificadas y pruebas con OTDR.',
                features: ['Monomodo/multimodo', 'Fusiones certificadas', 'Pruebas OTDR', 'Documentación técnica'],
                color: 'yellow',
                emoji: '💡',
          ...
          >
            ...
            <div className="grid md:grid-cols-4 gap-6">
              {[
                { icon: Zap, label: 'Alto Rendimiento', desc: 'Velocidades de hasta 10Gbps' },
                { icon: Shield, label: 'Seguro', desc: 'VLANs y firewall configurados' },
                { icon: CheckCircle, label: 'Certificado', desc: 'Cumple normas TIA/EIA' },
                { icon: Server, label: 'Escalable', desc: 'Crece con tu empresa' },
              ].map((benefit, idx) => (
