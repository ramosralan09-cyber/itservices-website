...
const categories = [
  {
    ...
    isRedesCard: true,
    description: 'Diseño y despliegue de redes robustas: switching administrable, VLANs, Wi-Fi empresarial y enlaces (fibra/PTP). Instalación limpia, etiquetado y documentación.',
    services: [
  ...
  },
  {
    ...
    isSecurityCard: true,
    description: 'CCTV IP (2MP–4K, PTZ, LPR), NVR y almacenamiento; control de acceso (TeleEntry, maglocks) y alarmas. Integración total para prevención y respuesta.',
    services: [
  ...
  },
  {
    ...
    description: 'Auditorías, diseños y BOM listos para ejecutar o licitar. Entregables claros y priorización de mejoras.',
    services: [
  ...
  },
  {
    ...
    description: 'Soporte remoto 1–3 h, visitas 24–48 h y emergencias 1–3 h. Mantenimientos preventivos/correctivos con checklist y bitácora.',
    services: [
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-4xl mx-auto">
              Infraestructura de red, videovigilancia, control de acceso y automatización — todo integrado, documentado y listo para escalar.
            </p>
          </motion.div>
                    ...
                    <div className="group rounded-2xl overflow-hidden card-elevated hover:-translate-y-1 hover:shadow-xl transition-all duration-300 bg-charcoal border border-white/10">
                      ...
                      <div className="p-6 md:p-8">
                        <div className="flex items-start justify-between mb-4">
                          ...
                          <span className="text-xs text-gray-400 font-medium">{category.projects}</span>
                        </div>
                        ...
                        <ul className="space-y-1.5 mb-4">
                          {category.services.map((service) => (
                            <li key={service} className="flex items-center text-gray-300 text-sm">
                        ...
                        <div className="text-white text-sm font-medium mb-6">{category.brands}</div>
