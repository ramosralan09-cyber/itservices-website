...
import { Headphones, Clock, Monitor, Wrench, CheckCircle, MessageCircle, Phone, Shield, Zap } from 'lucide-react';
...
export default function SoportePage() {
  ...
  const whatsappLink = "https://wa.me/19392842551?text=Hola%2C%20estoy%20interesado%20en%20una%20cotizaci%C3%B3n%20con%20IT%20Services%20%26%20Security.%20Servicio%3A%20Soporte%20T%C3%A9cnico%20%7C%20Nombre%3A%20%5BEscribir%5D%20%7C%20Tel%C3%A9fono%3A%20%5Bxxx-xxx-xxxx%5D";
        ...
        <div className="container mx-auto px-6 relative z-10 py-20">
          ...
          >
            ...
            >
              ...
              <Link href="/garantias" className="text-blue-400 text-sm hover:text-blue-300 transition-colors">
            ...
            {[
              {
                ...
                description: 'Diagnóstico y resolución de problemas sin necesidad de visita. Más rápido y económico para la mayoría de casos.',
                features: ['Acceso seguro', 'Resolución inmediata', 'Sin costo de viaje', 'Horario flexible'],
                color: 'blue',
                emoji: '💻',
                badge: 'Más Rápido',
              ...
              },
              {
                ...
                description: 'Visitas técnicas cuando se requiere intervención física. Instalación, configuración o reparaciones.',
                features: ['Técnico certificado', 'Herramientas incluidas', 'Diagnóstico completo', 'Reparación inmediata'],
                color: 'green',
                emoji: '🔧',
                badge: 'Profesional',
              ...
              },
              {
                ...
                description: 'Visitas programadas para mantener tu infraestructura en óptimas condiciones y prevenir fallas.',
                features: ['Visitas mensuales', 'Reportes detallados', 'Actualización firmware', 'Prioridad 24/7'],
                color: 'yellow',
                emoji: '⏰',
                badge: 'Recomendado',
              ...
              >
                <div className={`absolute inset-0 bg-${support.color}-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300`}></div>
                ...
                <div className="relative z-10">
                  ...
                  <ul className="space-y-2">
                    {support.features.map((feature, idx) => (
                      ...
                      >
                        <CheckCircle className={`w-4 h-4 text-${support.color}-400 flex-shrink-0`} />
                        <span>{feature}</span>
                      </motion.li>
                    ))}
                  </ul>
