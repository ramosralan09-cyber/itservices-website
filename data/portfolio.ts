...
export const portfolioProjects: PortfolioProject[] = [
  {
    ...
    images: Array.from({ length: 5 }, (_, i) => `/portfolio/cuartel-policia-cabo-rojo/imagen-${i + 1}.jpg`),
    coverImage: '/portfolio/cuartel-policia-cabo-rojo/portada.jpg',
  ...
  },
  {
    ...
    images: Array.from({ length: 3 }, (_, i) => `/portfolio/ricomini-camuy/imagen-${i + 1}.jpg`),
    coverImage: '/portfolio/ricomini-camuy/portada.jpg',
  ...
  },
  {
    ...
    images: Array.from({ length: 3 }, (_, i) => `/portfolio/pr-9-ponce/imagen-${i + 1}.jpg`),
    coverImage: '/portfolio/pr-9-ponce/portada.jpg',
  ...
  },
  {
    ...
    images: ['/portfolio/mayaguez-square-district/imagen-1.jpg'],
    coverImage: '/portfolio/mayaguez-square-district/portada.jpg',
  ...
  },
  {
    ...
    images: Array.from({ length: 3 }, (_, i) => `/portfolio/infosys-aguadilla/imagen-${i + 1}.jpg`),
    coverImage: '/portfolio/infosys-aguadilla/portada.jpg',
  ...
  },
  {
    ...
    coverImage: '/portfolio/vistas-del-rio-apartments/portada.jpg',
