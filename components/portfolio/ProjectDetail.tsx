              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-slate p-4 rounded-xl">
                  ...
                  <p className="text-white font-bold">
                    {new Date(project.completedDate + '-01').toLocaleDateString('es-PR', {
                      month: 'long',
                      year: 'numeric',
                    })}
                  </p>
          ...
          <div className="max-w-4xl mx-auto space-y-14">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-white">La Solución</h2>
              </div>
                  ...
                  {project.results
                    ...
                    .map((result, i) => (
                      <div key={i} className="flex items-start gap-3">
                        ...
                        <span className="text-gray-300 text-lg">{result.trim()}.</span>
                      </div>
                    ))}
                </div>
              </div>
